...
unsigned char *r,*g,*b;
int i,j;
unsigned char bmp1[320000];     //20060925 ×ª»»BMP

uu=(unsigned int)malloc(w*h);
vv=(unsigned int)malloc(w*h);
...
v=vv;
        ...
        for(i=0;i<w*h*3;i++)
          bmp1[i]=bmp[w*h*3-1-i];
    //    memcpy(yuv,yuv1,w*h*3);
...
//     unsigned char bmp2[320000];     //20060925 ×ª»»BMP
//     for(i=0;i<width*height*3;i++)
//       bmp2[i]=dst_ori[width*height*3-1-i];
//     memcpy(dst_ori,bmp2,width*height*3);        
}
